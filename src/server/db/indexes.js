...
export const INDEXES = {
  ...
  [C.categories]: [{ key: { shopId: 1, name: 1 }, name: "shop_name_unique", unique: true, collation: caseInsensitive }],
  [C.drawerEvents]: [{ key: { shiftId: 1 }, name: "shift" }, { key: { registerId: 1, at: -1 }, name: "register_time" }],
  [C.shifts]: [
    { key: { clientId: 1 }, name: "client_unique", unique: true },
